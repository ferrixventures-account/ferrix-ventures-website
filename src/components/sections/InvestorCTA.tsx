  ...
  return (
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-12">
                    <h2 className="text-4xl md:text-5xl font-bold text-background mb-6 tracking-tight animate-fade-in-up">
            {content.investorTitle.split('\n').map((line, idx) => (
              <React.Fragment key={idx}>
                ...
                <br />
                              ...
                              <p className="text-lg md:text-xl text-background/80 font-light max-w-2xl mx-auto">
            {content.investorDesc}
          </p>
        </div>
        <div className="flex justify-center">
                              <Card className="w-full max-w-[28rem] animate-fade-in pt-8 pb-4 px-6">
